...
from dataset_preprocessing.BaseDataset import BaseDataset
...
class ML20MDataset(BaseDataset):
    ...
    def load_inter_data(self):
        return pd.read_csv(self.inter_file, delimiter=self.sep, engine='python', encoding="ISO-8859-1")
...
class HMDataset(BaseDataset):
    def __init__(self, dataset_name):
        super(HMDataset, self).__init__(dataset_name)
