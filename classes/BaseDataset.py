...
class BaseDataset(object):
    def __init__(self, dataset_name):
        ...
        self.input_path = os.path.join("training_data", dataset_name)
        self.output_path = os.path.join("training_data", dataset_name)
        ...
        # output file
        self.output_inter_file = os.path.join(self.output_path, f'{self.dataset_name}.inter')
        self.output_item_file = os.path.join(self.output_path, f'{self.dataset_name}.item')
        self.output_user_file = os.path.join(self.output_path, f'{self.dataset_name}.user')
